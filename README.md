...
**图像增强：** 随机被压缩到![](http://latex.codecogs.com/svg.latex?[256,480])之间，做尺度增强，用![](http://latex.codecogs.com/svg.latex?224)x![](http://latex.codecogs.com/svg.latex?224)随机截取小图，再做水平镜像作为图像的增强  
